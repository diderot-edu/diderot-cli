...
def test_unauthorized_request(api_client, mk_chapter):
    ...
    url = (MANAGE_BOOK_API + "parts/{part_id}/manage-chapters/{chapter_id}/{action}/").format(**route_params)
...
def test_create_chapter(api_client, part, pi):
    ...
    url = (MANAGE_BOOK_API + "parts/{part_id}/manage-chapters/").format(**route_params)
    data = {"title": "title", "label": "label", "rank": 1}
    response = api_client.post(url, data)
