...
def multi_options_decorator(*opts):
    def decorator(f):
...
username = click.option("--username", "-u")
password = click.option("--password", "-p", help="DEPRECATED. This option will be removed in future versions.")
...
api = multi_options_decorator(url, credentials, username, password)
