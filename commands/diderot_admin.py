...
import commands.diderot_user as student
import options as opts

from context import DiderotContext, pass_diderot_context
from diderot_api import uses_api
...
@click.command()
@args.multi_arguments_decorator(args.course, args.title, args.chapter_label)
@uses_api
@pass_diderot_context
...
@click.command()
@args.multi_arguments_decorator(args.course, args.book)
@opts.multi_options_decorator(opts.part_number, opts.chapter_number, opts.chapter_label, opts.title)
@uses_api
@pass_diderot_context
...
@click.command()
@args.multi_arguments_decorator(args.course, args.book, args.title)
@opts.multi_options_decorator(opts.chapter_number, opts.chapter_label)
@uses_api
@pass_diderot_context
...
@click.command()
@args.multi_arguments_decorator(args.course, args.book)
@opts.multi_options_decorator(opts.chapter_number, opts.chapter_label, opts.publish_date, opts.publish_on_week)
@uses_api
@pass_diderot_context
...
@click.command()
@args.multi_arguments_decorator(args.course, args.homework)
@opts.multi_options_decorator(opts.autograde_tar, opts.autograde_makefile, opts.handout)
@uses_api
@pass_diderot_context
